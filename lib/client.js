window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region src/host/idle-followup.ts
		/**
		...
		*/
		...
		function AgentKernelHeaderAction({ sessionId, useAgentKernelHeader, watch, unwatch, setEnabled, saveSettings, claimPair, setSettingsOpen, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					followupClock.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		//#endregion
		//#region src/client/followup-index.ts
		...
		*/
		...
		var FollowupRowMark_module_css_default = { "mark": "M_cbAa_mark" };
		//#endregion
		//#region src/client/FollowupRowMark.tsx
		/**
